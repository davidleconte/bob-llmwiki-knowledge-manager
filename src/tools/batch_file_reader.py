...
class BatchFileReader:
    ...
    def _read_full(self, file_path: Path, max_lines: int) -> Dict:
        ...
        try:
            ...
            return {"strategy": "full", "error": "Binary file or encoding issue", "is_binary": True}
    ...
    def _read_summary(self, file_path: Path) -> Dict:
        ...
        try:
            ...
            return {"strategy": "summary", "error": str(e)}
    ...
    def _read_search(self, file_path: Path, pattern: Optional[str]) -> Dict:
        ...
        if not pattern:
            return {"strategy": "search", "error": "No search pattern provided"}
        ...
        try:
            ...
            return {"strategy": "search", "error": str(e)}
...
def main():
    ...
    parser.add_argument(
        "--strategy", choices=["full", "summary", "search"], default="full", help="Reading strategy"
    )
