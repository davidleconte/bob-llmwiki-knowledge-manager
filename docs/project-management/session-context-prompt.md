...
- **G** — TOCTOU window in path-traversal is unnamed in `docs/security/threat-model.md` residual register
...
- `docs/quick-start.md` — C→A: onboarding flowchart, stale PHASE3 link removed
...
| `docs/security/threat-model.md` | STRIDE threat model (exemplary; supersedes retracted ADR-012) |
...
| Low | Name the TOCTOU window explicitly in the threat model residual register | `docs/security/threat-model.md` |
